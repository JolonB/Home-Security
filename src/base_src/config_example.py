...
user_info = {1:{"rank": ranks["ADMIN"], "pin": "1234", "salt": "put some salt here"}, 2:{"rank": ranks["USER"], "pin": "5678", "salt": "put different salt here"}}
...
notif_kw = {"DISABLE": keywords["DISABLE"], "ENABLE": keywords["ENABLE"], "MUTE": keywords["MUTE"]}