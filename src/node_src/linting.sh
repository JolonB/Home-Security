...
printf "cpplint\n"
cpplint --recursive --root=. --filter=-build/include_subdir,-legal/copyright,-readability/casting,-readability/multiline_string --exclude=build/ --exclude=test/build/ --exclude=components/esp32-camera .
